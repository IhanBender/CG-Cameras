...
int main()
{
    ...
    Model city("/home/bender/Git/CG-Cameras/projeto/resources/objects/city/desert city.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (glfwGetKey(window, GLFW_KEY_V) == GLFW_RELEASE && r1){   
            camera.Translate(glm::vec3(10, 10, 10), float(0));
            r1 = false;
        }
        ...
        glm::mat4 model = city.TrasformationMatrix(currentFrame);
        ourShader.setMat4("model", model);
        city.Draw(ourShader);
