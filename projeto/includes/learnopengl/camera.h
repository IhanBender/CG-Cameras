...
public:
    ...
    void Translate(glm::vec3 newPosition, float time){
        this->Position = newPosition;
    }

    void Rotate(float angle, glm::vec3 axis, float time){
